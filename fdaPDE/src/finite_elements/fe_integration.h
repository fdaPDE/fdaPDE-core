...
template <> struct fe_quadrature_simplex<1, 1> : public fe_quadrature_simplex_base {
    ...
    static constexpr Vector<double, order> nodes {0.500000000000000};
    static constexpr Vector<double, order> weights {1.000000000000000};
};
...
template <> struct fe_quadrature_simplex<2, 4> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.333333333333333, 0.333333333333333, 0.600000000000000, 0.200000000000000, 0.200000000000000, 0.600000000000000,
...
template <> struct fe_quadrature_simplex<2, 6> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.445948490915965, 0.445948490915965, 0.445948490915965, 0.108103018168070, 0.108103018168070, 0.445948490915965,
       0.091576213509771, 0.091576213509771, 0.091576213509771, 0.816847572980459, 0.816847572980459,
       0.091576213509771}
    };
    static constexpr Vector<double, order> weights {
...
template <> struct fe_quadrature_simplex<2, 7> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.333333333333333, 0.333333333333333, 0.101286507323456, 0.101286507323456, 0.101286507323456, 0.797426985353087,
       0.797426985353087, 0.101286507323456, 0.470142064105115, 0.470142064105115, 0.470142064105115, 0.059715871789770,
       0.059715871789770, 0.470142064105115}
    };
    static constexpr Vector<double, order> weights {
      {0.225000000000000, 0.125939180544827, 0.125939180544827, 0.125939180544827, 0.132394152788506, 0.132394152788506,
       0.132394152788506}
    };
};
...
template <> struct fe_quadrature_simplex<2, 12> : public fe_quadrature_simplex_base {
    ...
    static constexpr Vector<double, order> weights {
      {0.050844906370207, 0.050844906370207, 0.050844906370207, 0.116786275726379, 0.116786275726379, 0.116786275726379,
       0.082851075618374, 0.082851075618374, 0.082851075618374, 0.082851075618374, 0.082851075618374,
       0.082851075618374}
    };
};
...
template <> struct fe_quadrature_simplex<3, 4> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.585410196624969, 0.138196601125011, 0.138196601125011, 0.138196601125011, 0.138196601125011, 0.138196601125011,
       0.138196601125011, 0.138196601125011, 0.585410196624969, 0.138196601125011, 0.585410196624969,
       0.138196601125011}
    };
    static constexpr Vector<double, order> weights {
...
template <> struct fe_quadrature_simplex<3, 5> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.250000000000000, 0.250000000000000, 0.250000000000000, 0.500000000000000, 0.166666666666667, 0.166666666666667,
       0.166666666666667, 0.500000000000000, 0.166666666666667, 0.166666666666667, 0.166666666666667, 0.500000000000000,
...
template <> struct fe_quadrature_simplex<3, 11> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.250000000000000, 0.250000000000000, 0.250000000000000, 0.785714285714285, 0.071428571428571, 0.071428571428571,
       0.071428571428571, 0.071428571428571, 0.071428571428571, 0.071428571428571, 0.071428571428571, 0.785714285714285,
       0.071428571428571, 0.785714285714285, 0.071428571428571, 0.100596423833200, 0.399403576166799, 0.399403576166799,
       0.399403576166799, 0.100596423833200, 0.399403576166799, 0.399403576166799, 0.399403576166799, 0.100596423833200,
       0.399403576166799, 0.100596423833200, 0.100596423833200, 0.100596423833200, 0.399403576166799, 0.100596423833200,
...
template <> struct fe_quadrature_simplex<3, 15> : public fe_quadrature_simplex_base {
    ...
    static constexpr Matrix<double, order, local_dim> nodes {
      {0.250000000000000, 0.250000000000000, 0.250000000000000, 0.000000000000000, 0.333333333333333, 0.333333333333333,
       0.333333333333333, 0.333333333333333, 0.333333333333333, 0.333333333333333, 0.333333333333333, 0.000000000000000,
       0.333333333333333, 0.000000000000000, 0.333333333333333, 0.727272727272727, 0.090909090909090, 0.090909090909090,
       0.090909090909090, 0.090909090909090, 0.090909090909090, 0.090909090909090, 0.090909090909090, 0.727272727272727,
       0.090909090909090, 0.727272727272727, 0.090909090909090, 0.433449846426335, 0.066550153573664, 0.066550153573664,
       0.066550153573664, 0.433449846426335, 0.066550153573664, 0.066550153573664, 0.066550153573664, 0.433449846426335,
       0.066550153573664, 0.433449846426335, 0.433449846426335, 0.433449846426335, 0.066550153573664, 0.433449846426335,
       0.433449846426335, 0.433449846426335, 0.066550153573664}
    };
    static constexpr Vector<double, order> weights {
      {0.181702068582535, 0.036160714285714, 0.036160714285714, 0.036160714285714, 0.036160714285714, 0.069871494516173,
       0.069871494516173, 0.069871494516173, 0.069871494516173, 0.065694849368318, 0.065694849368318, 0.065694849368318,
       0.065694849368318, 0.065694849368318, 0.065694849368318}
    };
};
...
// 1D formulas
[[maybe_unused]] static struct QS1DP1_ : internals::fe_quadrature_simplex<1, 1> {
} QS1DP1;
[[maybe_unused]] static struct QS1DP3_ : internals::fe_quadrature_simplex<1, 2> {
} QS1DP3;
[[maybe_unused]] static struct QS1DP5_ : internals::fe_quadrature_simplex<1, 3> {
} QS1DP5;
[[maybe_unused]] static struct QS1DP7_ : internals::fe_quadrature_simplex<1, 4> {
} QS1DP7;
// 2D formulas
[[maybe_unused]] static struct QS2DP1_ : internals::fe_quadrature_simplex<2, 1> {
} QS2DP1;
[[maybe_unused]] static struct QS2DP2_ : internals::fe_quadrature_simplex<2, 3> {
} QS2DP2;
[[maybe_unused]] static struct QS2DP3_ : internals::fe_quadrature_simplex<2, 4> {
} QS2DP3;
[[maybe_unused]] static struct QS2DP4_ : internals::fe_quadrature_simplex<2, 6> {
} QS2DP4;
[[maybe_unused]] static struct QS2DP5_ : internals::fe_quadrature_simplex<2, 7> {
} QS2DP5;
[[maybe_unused]] static struct QS2DP6_ : internals::fe_quadrature_simplex<2, 12> {
} QS2DP6;
// 3D formulas
[[maybe_unused]] static struct QS3DP1_ : internals::fe_quadrature_simplex<3, 1> {
} QS3DP1;
[[maybe_unused]] static struct QS3DP2_ : internals::fe_quadrature_simplex<3, 4> {
} QS3DP2;
[[maybe_unused]] static struct QS3DP3_ : internals::fe_quadrature_simplex<3, 5> {
} QS3DP3;
[[maybe_unused]] static struct QS3DP4_ : internals::fe_quadrature_simplex<3, 11> {
} QS3DP4;
[[maybe_unused]] static struct QS3DP5_ : internals::fe_quadrature_simplex<3, 15> {
} QS3DP5;
[[maybe_unused]] static struct QS3DP6_ : internals::fe_quadrature_simplex<3, 24> {
} QS3DP6;
