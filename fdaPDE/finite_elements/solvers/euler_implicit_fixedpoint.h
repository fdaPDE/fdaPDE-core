...
#ifndef __FEM_EULER_IMPLICIT_FIXEDPOINT_H__
#define __FEM_EULER_IMPLICIT_FIXEDPOINT_H__
...
struct FEMEulerImplicitFixedPoint : public FEMSolverBase<D, E, F, Ts...> {
...
public:
    ...
    void solve(PDE& pde) {
        ...
        DVector<double> f_prev = this->solution_.col(0); // solution at the previous step for the Fixed Pint method
...
#endif   // __FEM_EULER_IMPLICIT_FIXEDPOINT_H__