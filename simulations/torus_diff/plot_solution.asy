...
// === GRAPHICS ===
size(230);
currentprojection = perspective((10, 10,12),up=(0,0,1));
currentlight = light(
...
draw(origin -- (origin + (axisLength,0,0)), Arrow3(4bp)); label("$x$", origin + (axisLength+0.08,0,0),fontsize(6pt));
draw(origin -- (origin + (0,axisLength,0)), Arrow3(4bp)); label("$y$", origin + (0,axisLength+0.08,0),fontsize(6pt));
draw(origin -- (origin + (0,0,axisLength)), Arrow3(4bp)); label("$z$", origin + (0,-0.12,axisLength-0.15),fontsize(6pt));
