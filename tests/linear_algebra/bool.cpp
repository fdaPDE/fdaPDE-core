...
// checks at compile time: fdapde::internals::bitpack_count(0, 64) == 0
static_assert(fdapde::internals::bitpack_count(0, 64) == 0);
// checks at compile time: fdapde::internals::bitpack_count(1, 64) == 1
static_assert(fdapde::internals::bitpack_count(1, 64) == 1);
// checks at compile time: fdapde::internals::bitpack_count(63, 64) == 1
static_assert(fdapde::internals::bitpack_count(63, 64) == 1);
// checks at compile time: fdapde::internals::bitpack_count(64, 64) == 1
static_assert(fdapde::internals::bitpack_count(64, 64) == 1);
// checks at compile time: fdapde::internals::bitpack_count(65, 64) == 2
...
// checks at compile time: permits_boolean_binary<boolean_mask&, boolean_mask&, std::bit_and<>>
static_assert(permits_boolean_binary<boolean_mask&, boolean_mask&, std::bit_and<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_and<>>
static_assert(!permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_and<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_and<>>
static_assert(!permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_and<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_or<>>
static_assert(!permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_or<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_or<>>
static_assert(!permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_or<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_xor<>>
static_assert(!permits_boolean_binary<boolean_mask, boolean_mask&, std::bit_xor<>>);
// checks at compile time: !permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_xor<>>
static_assert(!permits_boolean_binary<boolean_mask&, boolean_mask, std::bit_xor<>>);
// checks at compile time: permits_boolean_negation<boolean_mask&>
static_assert(permits_boolean_negation<boolean_mask&>);
// checks at compile time: !permits_boolean_negation<boolean_mask>
static_assert(!permits_boolean_negation<boolean_mask>);
// checks at compile time: !exposes_boolean_rvalue_derived<boolean_mask>
static_assert(!exposes_boolean_rvalue_derived<boolean_mask>);
// checks at compile time: !permits_temporary_boolean_assignment<boolean_mask>
static_assert(!permits_temporary_boolean_assignment<boolean_mask>);
// checks at compile time: !permits_temporary_boolean_and_assignment<boolean_mask>
static_assert(!permits_temporary_boolean_and_assignment<boolean_mask>);
// checks at compile time: !permits_temporary_boolean_or_assignment<boolean_mask>
static_assert(!permits_temporary_boolean_or_assignment<boolean_mask>);
// checks at compile time: !permits_temporary_boolean_xor_assignment<boolean_mask>
static_assert(!permits_temporary_boolean_xor_assignment<boolean_mask>);
// checks at compile time: permits_named_boolean_chain<boolean_mask>
static_assert(permits_named_boolean_chain<boolean_mask>);
// checks at compile time: std::is_constructible_v<
...
// checks at compile time: fdapde::is_boolean_matrix_v<boolean_mask&>
static_assert(fdapde::is_boolean_matrix_v<boolean_mask&>);
// checks at compile time: fdapde::is_boolean_matrix_v<const boolean_mask&>
static_assert(fdapde::is_boolean_matrix_v<const boolean_mask&>);
// checks at compile time: fdapde::is_boolean_vector_v<const fdapde::Matrix<bool, 1, 2>&>
static_assert(fdapde::is_boolean_vector_v<const fdapde::Matrix<bool, 1, 2>&>);
// checks at compile time: !fdapde::is_boolean_vector_v<int>
...
// checks at compile time: permits_boolean_selection<selection_mask&, selection_values&, selection_values&>
static_assert(permits_boolean_selection<selection_mask&, selection_values&, selection_values&>);
// checks at compile time: !permits_boolean_selection<selection_mask, selection_values&, selection_values&>
static_assert(!permits_boolean_selection<selection_mask, selection_values&, selection_values&>);
// checks at compile time: !permits_boolean_selection<const selection_mask, selection_values&,
// selection_values&>
...
// checks at compile time: !permits_boolean_selection<selection_mask&, selection_values&, selection_values>
static_assert(!permits_boolean_selection<selection_mask&, selection_values&, selection_values>);
// checks at compile time: permits_boolean_selection<
static_assert(
  permits_boolean_selection<selection_condition_expression, selection_value_expression, selection_value_expression>);
// checks at compile time: permits_boolean_selection<selection_mask_view, selection_value_view,
// selection_values&>
static_assert(permits_boolean_selection<selection_mask_view, selection_value_view, selection_values&>);
// checks at compile time: safe_selection::ReadOnly == 1
static_assert(safe_selection::ReadOnly == 1);
// checks at compile time: safe_selection::StorageOrder == fdapde::RowMajor
static_assert(safe_selection::StorageOrder == fdapde::RowMajor);
// checks at compile time: std::same_as<typename safe_selection::Scalar, double>
...
// checks at compile time: exposes_boolean_repeat<repeat_owner&>
static_assert(exposes_boolean_repeat<repeat_owner&>);
// checks at compile time: exposes_boolean_repeat<const repeat_owner&>
static_assert(exposes_boolean_repeat<const repeat_owner&>);
// checks at compile time: !exposes_boolean_repeat<repeat_owner>
static_assert(!exposes_boolean_repeat<repeat_owner>);
// checks at compile time: !exposes_boolean_repeat<const repeat_owner>
static_assert(!exposes_boolean_repeat<const repeat_owner>);
// checks at compile time: exposes_boolean_repeat<repeat_expression>
static_assert(exposes_boolean_repeat<repeat_expression>);
// checks at compile time: exposes_boolean_repeat<repeat_view>
static_assert(exposes_boolean_repeat<repeat_view>);
// checks at compile time: repeat_result::Rows == fdapde::Dynamic
static_assert(repeat_result::Rows == fdapde::Dynamic);
// checks at compile time: repeat_result::Cols == fdapde::Dynamic
static_assert(repeat_result::Cols == fdapde::Dynamic);
// checks at compile time: repeat_result::StorageOrder == fdapde::RowMajor
static_assert(repeat_result::StorageOrder == fdapde::RowMajor);
// checks at compile time: repeat_result::ReadOnly == 1
static_assert(repeat_result::ReadOnly == 1);
// checks at compile time: repeat_result::NestAsRef == 0
static_assert(repeat_result::NestAsRef == 0);
// checks at compile time: std::same_as<typename repeat_result::Scalar, bool>
static_assert(std::same_as<typename repeat_result::Scalar, bool>);
// checks at compile time: std::is_constructible_v<direct_repeat, const repeat_owner&, int, int>
static_assert(std::is_constructible_v<direct_repeat, const repeat_owner&, int, int>);
// checks at compile time: !std::is_constructible_v<direct_repeat, repeat_owner&&, int, int>
...
// checks at compile time: exposes_static_boolean_block<boolean_block_owner&>
static_assert(exposes_static_boolean_block<boolean_block_owner&>);
// checks at compile time: exposes_dynamic_boolean_block<boolean_block_owner&>
static_assert(exposes_dynamic_boolean_block<boolean_block_owner&>);
// checks at compile time: exposes_boolean_row<boolean_block_owner&>
static_assert(exposes_boolean_row<boolean_block_owner&>);
// checks at compile time: exposes_boolean_col<boolean_block_owner&>
static_assert(exposes_boolean_col<boolean_block_owner&>);
// checks at compile time: exposes_static_boolean_top_rows<boolean_block_owner&>
static_assert(exposes_static_boolean_top_rows<boolean_block_owner&>);
// checks at compile time: exposes_dynamic_boolean_top_rows<boolean_block_owner&>
static_assert(exposes_dynamic_boolean_top_rows<boolean_block_owner&>);
// checks at compile time: exposes_static_boolean_bottom_rows<boolean_block_owner&>
static_assert(exposes_static_boolean_bottom_rows<boolean_block_owner&>);
// checks at compile time: exposes_dynamic_boolean_bottom_rows<boolean_block_owner&>
static_assert(exposes_dynamic_boolean_bottom_rows<boolean_block_owner&>);
// checks at compile time: exposes_static_boolean_left_cols<boolean_block_owner&>
static_assert(exposes_static_boolean_left_cols<boolean_block_owner&>);
// checks at compile time: exposes_dynamic_boolean_left_cols<boolean_block_owner&>
static_assert(exposes_dynamic_boolean_left_cols<boolean_block_owner&>);
// checks at compile time: exposes_static_boolean_right_cols<boolean_block_owner&>
static_assert(exposes_static_boolean_right_cols<boolean_block_owner&>);
// checks at compile time: exposes_dynamic_boolean_right_cols<boolean_block_owner&>
...
// checks at compile time: safe_boolean_expression_block::ReadOnly == 1
static_assert(safe_boolean_expression_block::ReadOnly == 1);

// checks at compile time: mutable_boolean_block::ReadOnly == 0
static_assert(mutable_boolean_block::ReadOnly == 0);
// checks at compile time: const_boolean_block::ReadOnly == 1
static_assert(const_boolean_block::ReadOnly == 1);
// checks at compile time: permits_boolean_block_coordinate_assignment<mutable_boolean_block>
static_assert(permits_boolean_block_coordinate_assignment<mutable_boolean_block>);
// checks at compile time: permits_boolean_block_vector_assignment<mutable_boolean_row>
static_assert(permits_boolean_block_vector_assignment<mutable_boolean_row>);
// checks at compile time: !permits_boolean_block_coordinate_assignment<const mutable_boolean_block>
static_assert(!permits_boolean_block_coordinate_assignment<const mutable_boolean_block>);
// checks at compile time: !permits_boolean_block_vector_assignment<const mutable_boolean_row>
static_assert(!permits_boolean_block_vector_assignment<const mutable_boolean_row>);
// checks at compile time: !permits_boolean_block_coordinate_assignment<const_boolean_block>
static_assert(!permits_boolean_block_coordinate_assignment<const_boolean_block>);
// checks at compile time: !permits_boolean_block_vector_assignment<const_boolean_row>
static_assert(!permits_boolean_block_vector_assignment<const_boolean_row>);
// checks at compile time: !permits_boolean_block_mutation<const_boolean_block>
...
// checks at compile time: !std::is_constructible_v<direct_boolean_row_block, boolean_block_owner&&, int>
static_assert(!std::is_constructible_v<direct_boolean_row_block, boolean_block_owner&&, int>);
// checks at compile time: !std::is_constructible_v<direct_static_boolean_block, boolean_block_owner&&, int,
// int>
...
// checks at compile time: exposes_static_boolean_matrix_reshape<boolean_reshape_owner&>
static_assert(exposes_static_boolean_matrix_reshape<boolean_reshape_owner&>);
// checks at compile time: exposes_static_boolean_vector_reshape<boolean_reshape_owner&>
static_assert(exposes_static_boolean_vector_reshape<boolean_reshape_owner&>);
// checks at compile time: exposes_dynamic_boolean_matrix_reshape<boolean_reshape_owner&>
static_assert(exposes_dynamic_boolean_matrix_reshape<boolean_reshape_owner&>);
// checks at compile time: exposes_dynamic_boolean_vector_reshape<boolean_reshape_owner&>
...
// checks at compile time: exposes_all_safe_boolean_reshape_accessors<safe_boolean_reshape_expression, 1>
static_assert(exposes_all_safe_boolean_reshape_accessors<safe_boolean_reshape_expression, 1>);
// checks at compile time: exposes_all_safe_boolean_reshape_accessors<const safe_boolean_reshape_expression, 1>
static_assert(exposes_all_safe_boolean_reshape_accessors<const safe_boolean_reshape_expression, 1>);
// checks at compile time: !permits_direct_temporary_static_boolean_reshape<boolean_reshape_owner>
static_assert(!permits_direct_temporary_static_boolean_reshape<boolean_reshape_owner>);
// checks at compile time: !permits_direct_temporary_dynamic_boolean_reshape<boolean_reshape_owner>
static_assert(!permits_direct_temporary_dynamic_boolean_reshape<boolean_reshape_owner>);
// checks at compile time: !permits_direct_temporary_vector_boolean_reshape<boolean_reshape_owner>
static_assert(!permits_direct_temporary_vector_boolean_reshape<boolean_reshape_owner>);
// checks at compile time: !permits_direct_temporary_static_boolean_reshape<const boolean_reshape_owner>
static_assert(!permits_direct_temporary_static_boolean_reshape<const boolean_reshape_owner>);
// checks at compile time: !permits_direct_temporary_dynamic_boolean_reshape<const boolean_reshape_owner>
static_assert(!permits_direct_temporary_dynamic_boolean_reshape<const boolean_reshape_owner>);
// checks at compile time: !permits_direct_temporary_vector_boolean_reshape<const boolean_reshape_owner>
static_assert(!permits_direct_temporary_vector_boolean_reshape<const boolean_reshape_owner>);
// checks at compile time: mutable_boolean_matrix_reshape::ReadOnly == 0
static_assert(mutable_boolean_matrix_reshape::ReadOnly == 0);
// checks at compile time: const_owner_boolean_matrix_reshape::ReadOnly == 1
static_assert(const_owner_boolean_matrix_reshape::ReadOnly == 1);
// checks at compile time: permits_boolean_reshape_coordinate_write<mutable_boolean_matrix_reshape>
static_assert(permits_boolean_reshape_coordinate_write<mutable_boolean_matrix_reshape>);
// checks at compile time: permits_boolean_reshape_vector_write<mutable_boolean_vector_reshape>
static_assert(permits_boolean_reshape_vector_write<mutable_boolean_vector_reshape>);
// checks at compile time: !permits_boolean_reshape_coordinate_write<const mutable_boolean_matrix_reshape>
static_assert(!permits_boolean_reshape_coordinate_write<const mutable_boolean_matrix_reshape>);
// checks at compile time: !permits_boolean_reshape_vector_write<const mutable_boolean_vector_reshape>
static_assert(!permits_boolean_reshape_vector_write<const mutable_boolean_vector_reshape>);
// checks at compile time: !permits_boolean_reshape_coordinate_write<const_owner_boolean_matrix_reshape>
static_assert(!permits_boolean_reshape_coordinate_write<const_owner_boolean_matrix_reshape>);
// checks at compile time: !permits_boolean_reshape_vector_write<const_owner_boolean_vector_reshape>
static_assert(!permits_boolean_reshape_vector_write<const_owner_boolean_vector_reshape>);
// checks at compile time: permits_boolean_reshape_assignment<mutable_boolean_matrix_reshape>
static_assert(permits_boolean_reshape_assignment<mutable_boolean_matrix_reshape>);
// checks at compile time: !permits_boolean_reshape_assignment<const_owner_boolean_matrix_reshape>
...
// checks at compile time: std::is_same_v<temporary_boolean_reshape_assignment_result,
// mutable_boolean_matrix_reshape>
...
// checks at compile time: !std::is_default_constructible_v<fixed_boolean_view>
static_assert(!std::is_default_constructible_v<fixed_boolean_view>);
// checks at compile time: !std::is_default_constructible_v<fixed_const_boolean_view>
static_assert(!std::is_default_constructible_v<fixed_const_boolean_view>);
// checks at compile time: std::is_default_constructible_v<dynamic_boolean_view>
static_assert(std::is_default_constructible_v<dynamic_boolean_view>);
// checks at compile time: std::is_default_constructible_v<partial_boolean_view>
static_assert(std::is_default_constructible_v<partial_boolean_view>);
// checks at compile time: std::is_default_constructible_v<dynamic_const_boolean_view>
static_assert(std::is_default_constructible_v<dynamic_const_boolean_view>);
// checks at compile time: std::is_constructible_v<fixed_boolean_view, boolean_view_word*>
static_assert(std::is_constructible_v<fixed_boolean_view, boolean_view_word*>);
// checks at compile time: !std::is_constructible_v<fixed_boolean_view, const boolean_view_word*>
static_assert(!std::is_constructible_v<fixed_boolean_view, const boolean_view_word*>);
// checks at compile time: !std::is_constructible_v<fixed_boolean_view, bool*>
static_assert(!std::is_constructible_v<fixed_boolean_view, bool*>);
// checks at compile time: !std::is_constructible_v<fixed_boolean_view, unsigned char*>
static_assert(!std::is_constructible_v<fixed_boolean_view, unsigned char*>);
// checks at compile time: std::is_constructible_v<fixed_const_boolean_view, boolean_view_word*>
static_assert(std::is_constructible_v<fixed_const_boolean_view, boolean_view_word*>);
// checks at compile time: std::is_constructible_v<fixed_const_boolean_view, const boolean_view_word*>
static_assert(std::is_constructible_v<fixed_const_boolean_view, const boolean_view_word*>);
// checks at compile time: !std::is_constructible_v<fixed_const_boolean_view, const bool*>
static_assert(!std::is_constructible_v<fixed_const_boolean_view, const bool*>);
// checks at compile time: std::is_same_v<decltype(std::declval<fixed_boolean_view&>().data()),
// boolean_view_word*>
...
// checks at compile time: fdapde::is_boolean_matrix_v<fixed_const_boolean_view>
static_assert(fdapde::is_boolean_matrix_v<fixed_const_boolean_view>);
// checks at compile time: fixed_const_boolean_view::ReadOnly == 1
static_assert(fixed_const_boolean_view::ReadOnly == 1);
// checks at compile time: permits_boolean_view_coordinate_write<fixed_boolean_view>
static_assert(permits_boolean_view_coordinate_write<fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_coordinate_write<const fixed_boolean_view>
static_assert(!permits_boolean_view_coordinate_write<const fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_coordinate_write<fixed_const_boolean_view>
static_assert(!permits_boolean_view_coordinate_write<fixed_const_boolean_view>);
// checks at compile time: permits_boolean_view_vector_write<fdapde::MatrixView<bool, 1, 3>>
static_assert(permits_boolean_view_vector_write<fdapde::MatrixView<bool, 1, 3>>);
// checks at compile time: !permits_boolean_view_vector_write<const fdapde::MatrixView<bool, 1, 3>>
static_assert(!permits_boolean_view_vector_write<const fdapde::MatrixView<bool, 1, 3>>);
// checks at compile time: !permits_boolean_view_vector_write<fdapde::MatrixView<const bool, 1, 3>>
static_assert(!permits_boolean_view_vector_write<fdapde::MatrixView<const bool, 1, 3>>);
// checks at compile time: permits_boolean_view_bulk_mutation<fixed_boolean_view>
static_assert(permits_boolean_view_bulk_mutation<fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_bulk_mutation<const fixed_boolean_view>
static_assert(!permits_boolean_view_bulk_mutation<const fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_bulk_mutation<fixed_const_boolean_view>
static_assert(!permits_boolean_view_bulk_mutation<fixed_const_boolean_view>);
// checks at compile time: permits_boolean_view_assignment<fixed_boolean_view, fixed_boolean_view>
static_assert(permits_boolean_view_assignment<fixed_boolean_view, fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_assignment<fixed_const_boolean_view, fixed_const_boolean_view>
static_assert(!permits_boolean_view_assignment<fixed_const_boolean_view, fixed_const_boolean_view>);
// checks at compile time: permits_boolean_view_compound_assignment<fixed_boolean_view>
static_assert(permits_boolean_view_compound_assignment<fixed_boolean_view>);
// checks at compile time: !permits_boolean_view_compound_assignment<fixed_const_boolean_view>
...
// checks at compile time: std::is_same_v<temporary_boolean_view_assignment_result, fixed_boolean_view>
...
template <int StorageOrder> void check_exact_boolean_pack_accounting() {
    ...
    // checks at compile time: exact_pack::StorageSize == 1
    static_assert(exact_pack::StorageSize == 1);
    // checks at compile time: partial_pack::StorageSize == 2
    static_assert(partial_pack::StorageSize == 2);

    exact_pack bits;
    // compares bits.bitpacks(), 1 using eq semantics
    EXPECT_EQ(bits.bitpacks(), 1);
    // compares bits.bitpack(0), 0u using eq semantics
    EXPECT_EQ(bits.bitpack(0), 0u);
    bits(1, 6) = true;
    constexpr int expected_bit = StorageOrder == fdapde::RowMajor ? 14 : 49;
    // compares bits.bitpack(0) & (typename exact_pack::bitpack_t(1) << expected_bit), 0u using ne semantics
    ...
    // compares partial.bitpacks(), 2 using eq semantics
    EXPECT_EQ(partial.bitpacks(), 2);
    // compares partial.bitpack(0), 0u using eq semantics
    EXPECT_EQ(partial.bitpack(0), 0u);
    // compares partial.bitpack(1), 0u using eq semantics
    EXPECT_EQ(partial.bitpack(1), 0u);

    partial_owner normalized_owner(2, 64);
    // compares normalized_owner.rows(), 2 using eq semantics
    EXPECT_EQ(normalized_owner.rows(), 2);
    // compares normalized_owner.cols(), 64 using eq semantics
    EXPECT_EQ(normalized_owner.cols(), 64);
    // compares normalized_owner.bitpacks(), 2 using eq semantics
    EXPECT_EQ(normalized_owner.bitpacks(), 2);
    normalized_owner(1, 63) = true;
    // checks normalized_owner(1, 63)
    ...
    for (int i = 0; i < block_owner.rows(); ++i) {
        for (int j = 0; j < block_owner.cols(); ++j) {
            // compares bool(block_owner(i, j)), i >= 6 && j >= 5 using eq semantics
    ...
    // compares view.bitpacks(), 1 using eq semantics
    EXPECT_EQ(view.bitpacks(), 1);
    view.set();
    // compares storage[0], std::numeric_limits<bitpack_t>::max() using eq semantics
    EXPECT_EQ(storage[0], std::numeric_limits<bitpack_t>::max());
    // compares storage[1], canary using eq semantics
    EXPECT_EQ(storage[1], canary);
    // checks view == exact_pack(true)
    EXPECT_TRUE(view == exact_pack(true));
    view.clear();
    // compares storage[0], bitpack_t(0) using eq semantics
    ...
    // compares normalized_view.rows(), 2 using eq semantics
    EXPECT_EQ(normalized_view.rows(), 2);
    // compares normalized_view.cols(), 64 using eq semantics
    EXPECT_EQ(normalized_view.cols(), 64);
    // compares normalized_view.bitpacks(), 2 using eq semantics
    EXPECT_EQ(normalized_view.bitpacks(), 2);
    normalized_view.set(1, 63);
    // checks normalized_view(1, 63)
    EXPECT_TRUE(normalized_view(1, 63));
    // compares partial_storage[2], canary using eq semantics
...
template <int StorageOrder> void check_boolean_owner_contracts() {
    ...
    const auto expect_logical_values = [&expected](const auto& matrix) {
        ...
        for (int i = 0; i < matrix.rows(); ++i) {
            for (int j = 0; j < matrix.cols(); ++j) {
                // compares bool(matrix(i, j)), expected[static_cast<std::size_t>(i * matrix.cols() + j)] using
                // eq semantics
    ...
    // compares boundary_vector.size(), 130 using eq semantics
    EXPECT_EQ(boundary_vector.size(), 130);
    for (int i = 0; i < boundary_vector.size(); ++i) {
        // compares bool(boundary_vector[i]), i == 0 || i == 63 || i == 64 || i == 129 using eq semantics
    ...
    // compares copy_target.rows(), 2 using eq semantics
    EXPECT_EQ(copy_target.rows(), 2);
    // compares copy_target.cols(), 65 using eq semantics
    EXPECT_EQ(copy_target.cols(), 65);
    // compares copy_target.bitpacks(), 3 using eq semantics
    EXPECT_EQ(copy_target.bitpacks(), 3);
    // compares copy_target.count(), 2 using eq semantics
    EXPECT_EQ(copy_target.count(), 2);
    // checks copy_target(0, 0)
    EXPECT_TRUE(copy_target(0, 0));
    // checks copy_target(1, 64)
    ...
    // compares row_zero_xpr.rows(), 1 using eq semantics
    EXPECT_EQ(row_zero_xpr.rows(), 1);
    // compares row_zero_xpr.cols(), 5 using eq semantics
    EXPECT_EQ(row_zero_xpr.cols(), 5);
    // compares row_ones_xpr.rows(), 1 using eq semantics
    EXPECT_EQ(row_ones_xpr.rows(), 1);
    // compares row_ones_xpr.cols(), 5 using eq semantics
    ...
    // compares column_zero.rows(), 5 using eq semantics
    EXPECT_EQ(column_zero.rows(), 5);
    // compares column_zero.cols(), 1 using eq semantics
    EXPECT_EQ(column_zero.cols(), 1);
    // checks column_zero.any()
    EXPECT_FALSE(column_zero.any());
    // checks column_ones.all()
    ...
    // compares stable_resize.rows(), 20 using eq semantics
    EXPECT_EQ(stable_resize.rows(), 20);
    // compares stable_resize.cols(), 20 using eq semantics
    EXPECT_EQ(stable_resize.cols(), 20);
    // checks stable_resize.any()
    ...
    // compares same_size_resize.count(), 3 using eq semantics
    EXPECT_EQ(same_size_resize.count(), 3);
    same_size_resize.resize(3, 2);
    // compares same_size_resize.rows(), 3 using eq semantics
    EXPECT_EQ(same_size_resize.rows(), 3);
    // compares same_size_resize.cols(), 2 using eq semantics
    EXPECT_EQ(same_size_resize.cols(), 2);
    // checks same_size_resize.any()
    ...
    // compares partial.bitpacks(), partial_bitpacks using eq semantics
    ...
    // compares bounded.bitpacks(), bounded_bitpacks using eq semantics
...
template <int StorageOrder> void check_boolean_expression_contracts() {
    ...
    const auto expect_values = [](const auto& matrix, const auto& expected) {
        // compares matrix.size(), static_cast<int>(expected.size()) using eq semantics
    ...
    // compares (layout ^ other_layout).bitpack(0), typename layout_matrix::bitpack_t(0) using eq semantics
    ...
    // compares dynamic_lhs.rows(), 2 using eq semantics
    EXPECT_EQ(dynamic_lhs.rows(), 2);
    // compares dynamic_lhs.cols(), 3 using eq semantics
    EXPECT_EQ(dynamic_lhs.cols(), 3);
    // checks dynamic_lhs(0, 1)
    EXPECT_TRUE(dynamic_lhs(0, 1));
    // compares dynamic_lhs.count(), 1 using eq semantics
...
template <int StorageOrder> void check_boolean_block_contracts() {
    ...
    // compares static_block.rows(), 2 using eq semantics
    EXPECT_EQ(static_block.rows(), 2);
    // compares static_block.cols(), 2 using eq semantics
    ...
    // compares dynamic_block.rows(), 2 using eq semantics
    EXPECT_EQ(dynamic_block.rows(), 2);
    // compares dynamic_block.cols(), 2 using eq semantics
    ...
    // compares row_scalar.rows(), 1 using eq semantics
    EXPECT_EQ(row_scalar.rows(), 1);
    // compares row_scalar.cols(), 1 using eq semantics
    EXPECT_EQ(row_scalar.cols(), 1);
    // checks row_scalar(0, 0)
    EXPECT_TRUE(row_scalar(0, 0));
    row_scalar(0, 0) = false;
    // checks row_vector(0, 2)
    ...
    // compares column_scalar.rows(), 1 using eq semantics
    EXPECT_EQ(column_scalar.rows(), 1);
    // compares column_scalar.cols(), 1 using eq semantics
    EXPECT_EQ(column_scalar.cols(), 1);
    // checks column_scalar(0, 0)
    EXPECT_TRUE(column_scalar(0, 0));
    column_scalar(0, 0) = false;
    // checks column_vector(2, 0)
    ...
    // compares packed_block.bitpacks(), 2 using eq semantics
    ...
    if constexpr (StorageOrder == fdapde::RowMajor) {
        ...
        // compares packed_block.bitpack(1), bitpack_t(1) << 4 using eq semantics
        EXPECT_EQ(packed_block.bitpack(1), bitpack_t(1) << 4);
    } else {
        // compares packed_block.bitpack(0), (bitpack_t(1) << 2) | (bitpack_t(1) << 3) using eq semantics
        EXPECT_EQ(packed_block.bitpack(0), (bitpack_t(1) << 2) | (bitpack_t(1) << 3));
        // compares packed_block.bitpack(1), (bitpack_t(1) << 0) | (bitpack_t(1) << 4) using eq semantics
    ...
    // checks named_assignment(0, 0)
    EXPECT_FALSE(named_assignment(0, 0));
    // checks named_assignment(0, 2)
...
template <int StorageOrder> void check_boolean_reshape_contracts() {
    ...
    // compares static_reshape.bitpacks(), source.bitpacks() using eq semantics
    EXPECT_EQ(static_reshape.bitpacks(), source.bitpacks());
    // compares static_reshape.bitpack(0), source.bitpack(0) using eq semantics
    ...
    // compares packed_static_reshape.bitpacks(), 2 using eq semantics
    EXPECT_EQ(packed_static_reshape.bitpacks(), 2);
    // compares packed_dynamic_reshape.bitpacks(), 2 using eq semantics
    EXPECT_EQ(packed_dynamic_reshape.bitpacks(), 2);
    for (int i = 0; i < packed_source.bitpacks(); ++i) {
        // compares packed_static_reshape.bitpack(i), packed_source.bitpack(i) using eq semantics
        EXPECT_EQ(packed_static_reshape.bitpack(i), packed_source.bitpack(i));
        // compares packed_dynamic_reshape.bitpack(i), packed_source.bitpack(i) using eq semantics
        EXPECT_EQ(packed_dynamic_reshape.bitpack(i), packed_source.bitpack(i));
    }
    // checks packed_static_reshape[64]
    EXPECT_TRUE(packed_static_reshape[64]);
    // checks packed_column_reshape[64]
    ...
    // compares stored_packed_expression.bitpacks(), 2 using eq semantics
    EXPECT_EQ(stored_packed_expression.bitpacks(), 2);
    for (int i = 0; i < packed_source.bitpacks(); ++i) {
        // compares stored_packed_expression.bitpack(i), packed_source.bitpack(i) using eq semantics
    ...
    // compares direct_row.cols(), source.size() using eq semantics
    EXPECT_EQ(direct_row.cols(), source.size());
    for (int i = 0; i < source.size(); ++i) {
        // compares bool(row[i]), flat_expected[static_cast<std::size_t>(i)] using eq semantics
        EXPECT_EQ(bool(row[i]), flat_expected[static_cast<std::size_t>(i)]);
        // compares bool(column[i]), flat_expected[static_cast<std::size_t>(i)] using eq semantics
        EXPECT_EQ(bool(column[i]), flat_expected[static_cast<std::size_t>(i)]);
        // compares bool(direct_row[i]), flat_expected[static_cast<std::size_t>(i)] using eq semantics
    ...
    // compares empty_matrix.bitpacks(), 0 using eq semantics
    ...
    // compares empty_column.bitpacks(), 0 using eq semantics
...
template <int StorageOrder> void check_boolean_selection_contracts() {
    ...
    // compares dynamic_selected.rows(), 2 using eq semantics
    EXPECT_EQ(dynamic_selected.rows(), 2);
    // compares dynamic_selected.cols(), 3 using eq semantics
    EXPECT_EQ(dynamic_selected.cols(), 3);
    // compares dynamic_selected(0, 0), 1.0 using double_eq semantics
    EXPECT_DOUBLE_EQ(dynamic_selected(0, 0), 1.0);
    // compares dynamic_selected(0, 1), 3.0 using double_eq semantics
    EXPECT_DOUBLE_EQ(dynamic_selected(0, 1), 3.0);
    // compares dynamic_selected(1, 2), 2.0 using double_eq semantics
    ...
    // compares empty_selection.rows(), 0 using eq semantics
    EXPECT_EQ(empty_selection.rows(), 0);
    // compares empty_selection.cols(), 3 using eq semantics
    EXPECT_EQ(empty_selection.cols(), 3);
    // compares empty_selection.size(), 0 using eq semantics
    ...
    // compares nan_mask.rows(), 2 using eq semantics
    EXPECT_EQ(nan_mask.rows(), 2);
    // compares nan_mask.cols(), 2 using eq semantics
    EXPECT_EQ(nan_mask.cols(), 2);
    // checks bool(nan_mask(0, 0))
    EXPECT_FALSE(bool(nan_mask(0, 0)));
    // checks bool(nan_mask(0, 1))
    EXPECT_TRUE(bool(nan_mask(0, 1)));
    // checks bool(nan_mask(1, 0))
    EXPECT_FALSE(bool(nan_mask(1, 0)));
    // checks bool(nan_mask(1, 1))
    ...
    // compares nan_row_mask.rows(), 1 using eq semantics
    EXPECT_EQ(nan_row_mask.rows(), 1);
    // compares nan_row_mask.cols(), 3 using eq semantics
    EXPECT_EQ(nan_row_mask.cols(), 3);
    // checks bool(nan_row_mask(0, 0))
    EXPECT_TRUE(bool(nan_row_mask(0, 0)));
    // checks bool(nan_row_mask(0, 1))
    EXPECT_FALSE(bool(nan_row_mask(0, 1)));
    // checks bool(nan_row_mask(0, 2))
...
template <int StorageOrder> void check_boolean_repeat_contracts() {
    ...
    // compares repeated.rows(), 6 using eq semantics
    EXPECT_EQ(repeated.rows(), 6);
    // compares repeated.cols(), 16 using eq semantics
    EXPECT_EQ(repeated.cols(), 16);
    // compares repeated.bitpacks(), 2 using eq semantics
    EXPECT_EQ(repeated.bitpacks(), 2);
    // checks repeated.any()
    EXPECT_TRUE(repeated.any());
    // checks repeated.all()
    EXPECT_FALSE(repeated.all());
    // compares repeated.count(), source.count() * 8 using eq semantics
    ...
    for (int i = 0; i < expected.rows(); ++i) {
        for (int j = 0; j < expected.cols(); ++j) {
            ...
            // compares bool(repeated(i, j)), bool(expected(i, j)) using eq semantics
            EXPECT_EQ(bool(repeated(i, j)), bool(expected(i, j)));
        }
    }
    for (int i = 0; i < repeated.bitpacks(); ++i) {
        // compares repeated.bitpack(i), expected.bitpack(i) using eq semantics
    ...
    // compares tiled_column.rows(), 5 using eq semantics
    EXPECT_EQ(tiled_column.rows(), 5);
    // compares tiled_column.cols(), 4 using eq semantics
    EXPECT_EQ(tiled_column.cols(), 4);
    for (int i = 0; i < tiled_column.rows(); ++i) {
        for (int j = 0; j < tiled_column.cols(); ++j) {
            // compares bool(tiled_column(i, j)), bool(column[i]) using eq semantics
    ...
    // compares stored_result.rows(), 3 using eq semantics
    EXPECT_EQ(stored_result.rows(), 3);
    // compares stored_result.cols(), 8 using eq semantics
    EXPECT_EQ(stored_result.cols(), 8);
    for (int i = 0; i < stored_result.rows(); ++i) {
        for (int j = 0; j < stored_result.cols(); ++j) {
            // compares bool(stored_result(i, j)), !bool(source(i, j % source.cols())) using eq semantics
    ...
    // compares view_result.rows(), 6 using eq semantics
    EXPECT_EQ(view_result.rows(), 6);
    // compares view_result.cols(), 4 using eq semantics
    EXPECT_EQ(view_result.cols(), 4);
    for (int i = 0; i < view_result.rows(); ++i) {
        for (int j = 0; j < view_result.cols(); ++j) {
            // compares bool(view_result(i, j)), bool(source(i % source.rows(), j)) using eq semantics
    ...
    // compares aliased.rows(), 2 using eq semantics
    EXPECT_EQ(aliased.rows(), 2);
    // compares aliased.cols(), 3 using eq semantics
    EXPECT_EQ(aliased.cols(), 3);
    for (int i = 0; i < aliased.rows(); ++i) {
        // checks bool(aliased(i, 0))
        EXPECT_TRUE(bool(aliased(i, 0)));
        // checks bool(aliased(i, 1))
        EXPECT_FALSE(bool(aliased(i, 1)));
        // checks bool(aliased(i, 2))
    ...
    // compares repeated_zero_rows.rows(), 0 using eq semantics
    EXPECT_EQ(repeated_zero_rows.rows(), 0);
    // compares repeated_zero_rows.cols(), 12 using eq semantics
    EXPECT_EQ(repeated_zero_rows.cols(), 12);
    // compares repeated_zero_rows.bitpacks(), 0 using eq semantics
    EXPECT_EQ(repeated_zero_rows.bitpacks(), 0);
    // compares repeated_zero_cols.rows(), 6 using eq semantics
    EXPECT_EQ(repeated_zero_cols.rows(), 6);
    // compares repeated_zero_cols.cols(), 0 using eq semantics
    EXPECT_EQ(repeated_zero_cols.cols(), 0);
    // compares repeated_zero_cols.bitpacks(), 0 using eq semantics
...
template <int StorageOrder> void check_boolean_terminal_contracts() {
    ...
    // compares exact.count(), 64 using eq semantics
    ...
    // checks exact.any()
    EXPECT_TRUE(exact.any());
    // compares exact.count(), 63 using eq semantics
    ...
    // checks tail_layout == other_tail_layout
    ...
    // checks stored_tail_expression == other_tail_layout
    ...
    const layout_matrix layout(std::vector<bool>(layout_values.begin(), layout_values.end()));
    const opposite_layout_matrix other_layout(std::vector<bool>(layout_values.begin(), layout_values.end()));
    // checks layout == other_layout
    EXPECT_TRUE(layout == other_layout);
    // compares layout.which(true), (std::vector<int> {1, 2, 3}) using eq semantics
    EXPECT_EQ(layout.which(true), (std::vector<int> {1, 2, 3}));
    // compares layout.which(false), (std::vector<int> {0, 4, 5}) using eq semantics
    EXPECT_EQ(layout.which(false), (std::vector<int> {0, 4, 5}));
    // compares fdapde::which(layout), (std::vector<int> {1, 2, 3}) using eq semantics
    ...
    // compares stored_layout_expression.which(true), (std::vector<int> {1, 2, 3}) using eq semantics
    EXPECT_EQ(stored_layout_expression.which(true), (std::vector<int> {1, 2, 3}));
    // compares fdapde::which(stored_layout_expression), (std::vector<int> {1, 2, 3}) using eq semantics
    ...
    // checks empty.which(true).empty()
    EXPECT_TRUE(empty.which(true).empty());
    // checks empty.which(false).empty()
    EXPECT_TRUE(empty.which(false).empty());
    // checks fdapde::which(empty).empty()
    EXPECT_TRUE(fdapde::which(empty).empty());
    // checks zero_rows.which(true).empty()
    EXPECT_TRUE(zero_rows.which(true).empty());
    // checks zero_cols.which(false).empty()
...
template <int StorageOrder> void check_boolean_view_contracts() {
    ...
    // compares storage[0] & (bitpack_t(1) << mapped_bit), bitpack_t(0) using ne semantics
    EXPECT_NE(storage[0] & (bitpack_t(1) << mapped_bit), bitpack_t(0));
    // compares storage[1], outside_canary using eq semantics
    EXPECT_EQ(storage[1], outside_canary);
    const auto& const_view_handle = view;
    // checks bool(const_view_handle(1, 0))
    EXPECT_TRUE(bool(const_view_handle(1, 0)));

    const fixed_view shallow_alias(view);
    // compares shallow_alias.data(), view.data() using eq semantics
    ...
    // checks bool(view(0, 1))
    EXPECT_TRUE(bool(view(0, 1)));
    // checks bool(view(1, 2))
    EXPECT_TRUE(bool(view(1, 2)));
    // compares storage[0] & hidden_canary, hidden_canary using eq semantics
    ...
    for (int i = 0; i < owner.rows(); ++i) {
        // compares bool(view(i, j)), bool(owner(i, j)) using eq semantics
    ...
    other(1, 1) = true;
    view = other;
    // checks bool(view(0, 0))
    EXPECT_TRUE(bool(view(0, 0)));
    // checks bool(view(1, 1))
    ...
    // compares assigned_temporary.data(), temporary_storage.data() using eq semantics
    EXPECT_EQ(assigned_temporary.data(), temporary_storage.data());
    // checks bool(assigned_temporary(0, 1))
    EXPECT_TRUE(bool(assigned_temporary(0, 1)));
    // checks bool(assigned_temporary(1, 2))
    ...
    for (int i = 0; i < source.rows(); ++i) {
        for (int j = 0; j < source.cols(); ++j) {
            // compares bool(stored_result(i, j)), !bool(source(i, j)) using eq semantics
    ...
    // compares tail.bitpacks(), 2 using eq semantics
    EXPECT_EQ(tail.bitpacks(), 2);
    // compares partial.bitpacks(), 2 using eq semantics
    EXPECT_EQ(partial.bitpacks(), 2);
    tail(4, 12) = true;
    // compares tail.bitpack(1), bitpack_t(1) using eq semantics
    EXPECT_EQ(tail.bitpack(1), bitpack_t(1));
    // checks bool(partial(4, 12))
    EXPECT_TRUE(bool(partial(4, 12)));
    // compares tail_storage[2], outside_canary using eq semantics
    EXPECT_EQ(tail_storage[2], outside_canary);
    tail.set();
    // compares tail.bitpack(0), std::numeric_limits<bitpack_t>::max() using eq semantics
    EXPECT_EQ(tail.bitpack(0), std::numeric_limits<bitpack_t>::max());
    // compares tail.bitpack(1), bitpack_t(1) using eq semantics
    EXPECT_EQ(tail.bitpack(1), bitpack_t(1));
    // compares tail_storage[1] & hidden_canary, hidden_canary using eq semantics
    EXPECT_EQ(tail_storage[1] & hidden_canary, hidden_canary);
    // compares tail_storage[2], outside_canary using eq semantics
    EXPECT_EQ(tail_storage[2], outside_canary);
    tail.clear();
    // compares tail.bitpack(0), bitpack_t(0) using eq semantics
    EXPECT_EQ(tail.bitpack(0), bitpack_t(0));
    // compares tail.bitpack(1), bitpack_t(0) using eq semantics
    ...
    // compares read_only_tail.data(), tail_storage.data() using eq semantics
    EXPECT_EQ(read_only_tail.data(), tail_storage.data());
    // checks bool(read_only_tail(4, 12))
    ...
    // compares empty.bitpacks(), 0 using eq semantics
    EXPECT_EQ(empty.bitpacks(), 0);
    // compares partial_empty.rows(), 5 using eq semantics
    EXPECT_EQ(partial_empty.rows(), 5);
    // compares partial_empty.cols(), 0 using eq semantics
    EXPECT_EQ(partial_empty.cols(), 0);
    // compares partial_empty.data(), nullptr using eq semantics
    EXPECT_EQ(partial_empty.data(), nullptr);
    // compares partial_empty.bitpacks(), 0 using eq semantics
    EXPECT_EQ(partial_empty.bitpacks(), 0);
    // compares const_empty.data(), nullptr using eq semantics
    ...
    // compares mismatch_destination.data(), mismatch_binding using eq semantics
    EXPECT_EQ(mismatch_destination.data(), mismatch_binding);
    // compares mismatch_destination.rows(), 2 using eq semantics
    EXPECT_EQ(mismatch_destination.rows(), 2);
    // compares mismatch_destination.cols(), 2 using eq semantics
    EXPECT_EQ(mismatch_destination.cols(), 2);
    // compares mismatch_destination_storage[0], mismatch_snapshot using eq semantics
    ...
    // compares storage[0], bounds_snapshot using eq semantics
    EXPECT_EQ(storage[0], bounds_snapshot);
}

}   // namespace

// verifies boolean through the public algebra API
TEST(linear_algebra, boolean) {
    fdapde::Matrix<bool, 2, 3> fixed({true, false, true, false, true, false});
    // compares fixed.rows(), 2 using eq semantics
    EXPECT_EQ(fixed.rows(), 2);
    // compares fixed.cols(), 3 using eq semantics
    ...
    // checks copy(0, pack_size - 1)
    EXPECT_TRUE(copy(0, pack_size - 1));
    // checks copy(0, pack_size)
    ...
    const auto nan_mask = fdapde::nan_indicator(nan_values);
    // compares nan_mask.rows(), 3 using eq semantics
    EXPECT_EQ(nan_mask.rows(), 3);
    // compares nan_mask.cols(), 1 using eq semantics
    EXPECT_EQ(nan_mask.cols(), 1);
    // checks bool(nan_mask(0, 0))
    EXPECT_TRUE(bool(nan_mask(0, 0)));
    // checks bool(nan_mask(1, 0))
    EXPECT_FALSE(bool(nan_mask(1, 0)));
    // checks bool(nan_mask(2, 0))
    ...
    // compares marker_mask.rows(), 4 using eq semantics
    EXPECT_EQ(marker_mask.rows(), 4);
    // compares marker_mask.cols(), 1 using eq semantics
    EXPECT_EQ(marker_mask.cols(), 1);
    // checks bool(marker_mask[0])
    EXPECT_TRUE(bool(marker_mask[0]));
    // checks bool(marker_mask[1])
    EXPECT_FALSE(bool(marker_mask[1]));
    // checks bool(marker_mask[2])
    EXPECT_TRUE(bool(marker_mask[2]));
    // checks bool(marker_mask[3])
    EXPECT_FALSE(bool(marker_mask[3]));
    const auto empty_marker_mask = fdapde::value_indicator(markers.cend(), markers.cend(), 2);
    // compares empty_marker_mask.rows(), 0 using eq semantics
    EXPECT_EQ(empty_marker_mask.rows(), 0);
    // compares empty_marker_mask.cols(), 1 using eq semantics
